			...
			$.ajax({ 
							...
							success: function(returnData){
								...
								/*if(returnData&&returnData.code !== 0){
									...
									if(name === "deal_list_get"||name === "expend_get"||name === "income_get"||name === "point_get"||name === "group_member_get"||name === "collect_get"||name === "travel_get"||name === "diy_get"||name === "linker_get"||name === "invoice_get"||name === "email_get"){
										suc(returnData);
										}else{
