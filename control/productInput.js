				...
				$.each(result.traveler,function(i,n){
					if(n.a){
						goiparam.toursParam.push(n);
							...
							obj.pop.on("alert",{text:("请完成出游人信息")});
							correct=0;
							return false;
							}	
					});	
